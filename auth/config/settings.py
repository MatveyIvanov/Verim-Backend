...
DB_USER: str = os.environ.get("AUTH_DB_USER", "")
DB_PASSWORD: str = os.environ.get("AUTH_DB_PASSWORD", "")
DB_NAME: str = os.environ.get("AUTH_DB_NAME", "")
DB_HOST: str = os.environ.get("AUTH_DB_HOST", "")
DB_PORT: str = os.environ.get("AUTH_DB_PORT", "")
DATABASE_URL: str = os.environ.get("AUTH_DATABASE_URL", "")

TEST_DB_USER: str = os.environ.get("TEST_AUTH_DB_USER", "")
TEST_DB_PASSWORD: str = os.environ.get("TEST_AUTH_DB_PASSWORD", "")
TEST_DB_NAME: str = os.environ.get("TEST_AUTH_DB_NAME", "")
...
MAIL_PORT: int = int(os.environ.get("MAIL_PORT", 0))
